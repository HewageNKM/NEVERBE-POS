    ...
    return (
        <Card className="shadow-md rounded-lg w-[12rem] relative flex flex-col">
            ...
            <CardContent className="flex flex-col justify-between flex-grow p-4">
                ...
                <p className="text-sm mt-2">LKR {item.sellingPrice + (item.sellingPrice * item.discount / 100)} <span className="p-1 rounded text-white bg-yellow-800">-({item.discount}OFF)</span></p>
            </CardContent>
